...
public class Player2FieldController {
    ...
    void OnEnemyFieldButtonClick(ActionEvent e) throws IOException {
        ...
        //tombol next di scene ladang musuh akan di disable setelah menekan tombol ini
    ...
    void OnMyFieldButtonClick(ActionEvent event) {
        ...
        //Jika sekarang giliran pemain 1 (berada di ladang lawan)
        //Kembali ke ladang pemain 1
